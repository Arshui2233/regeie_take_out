...
import com.gjl.regeie.mapper.CategoryMapper;
...
@Service
public class CategoryServicesImpl extends ServiceImpl<CategoryMapper, Category> implements CategoryService {
...
int count1 =dishService.count(dishLambdaQueryWrapper);
        ...
        //查询当前分类是否关联了菜品，如果已经关联，抛出了一个业务异常
        if (count1 > 0){
            //已经关联菜品，抛出一个业务异常
        ...
        //查询当前分类是否关联了套餐，如果已经关联，抛出了一个业务异常
        if (count2 > 0){
            //已经关联套餐，抛出一个业务异常
